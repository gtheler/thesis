...
The tool should define and document ([@sec-srs-documentation]) the way the input files for a solving particular problem are to be prepared ([@sec-srs-input]) and how the results are to be written ([@sec-srs-output]).
