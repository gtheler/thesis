...
// spot rule
int sn_init_weights(int dimensions, int directions, int SN) {
  
  int m, n, j;
  
  // inicializacion de pesos y direcciones SN
  w = calloc(directions, sizeof(double));
  Omega = calloc(directions, sizeof(double *));
  ...
  if (dimensions == 1) {
    ...
    int N_octs = (dimensions == 2) ? 4 : 8;
    int J_octs = directions / N_octs;
    ...
    switch (SN) {
      case 2:
        ...
        Omega[0][2] = (dimensions == 3)?S2_MU1:0;
        w[0] =         S2_W1/(double)(N_octs);
      break;
      case 4:
        Omega[0][0] = s4_mu1;
        Omega[0][1] = s4_mu1;
        Omega[0][2] = (dimensions == 3)?s4_mu2:0;
        w[0] =         S4_W1/(double)(N_octs);

        Omega[1][0] = s4_mu1;
        Omega[1][1] = s4_mu2;
        Omega[1][2] = (dimensions == 3)?s4_mu1:0;
        w[1] =         S4_W1/(double)(N_octs);

        Omega[2][0] = s4_mu2;
        Omega[2][1] = s4_mu1;
        Omega[2][2] = (dimensions == 3)?s4_mu1:0;
        w[2] =         S4_W1/(double)(N_octs);
      break;
      case 6:
        Omega[0][0] = s6_mu1;
        Omega[0][1] = s6_mu1;
        Omega[0][2] = (dimensions == 3)?s6_mu3:0;
        w[0] =         S6_W1/(double)(N_octs);

        Omega[1][0] = s6_mu1;
        Omega[1][1] = s6_mu2;
        Omega[1][2] = (dimensions == 3)?s6_mu2:0;
        w[1] =         S6_W2/(double)(N_octs);
        
        Omega[2][0] = s6_mu2;
        Omega[2][1] = s6_mu1;
        Omega[2][2] = (dimensions == 3)?s6_mu2:0;
        w[2] =         S6_W2/(double)(N_octs);
        
        Omega[3][0] = s6_mu2;
        Omega[3][1] = s6_mu2;
        Omega[3][2] = (dimensions == 3)?s6_mu1:0;
        w[3] =         S6_W2/(double)(N_octs);

        Omega[4][0] = s6_mu3;
        Omega[4][1] = s6_mu1;
        Omega[4][2] = (dimensions == 3)?s6_mu1:0;
        w[4] =         S6_W1/(double)(N_octs);
        
        Omega[5][0] = s6_mu1;
        Omega[5][1] = s6_mu3;
        Omega[5][2] = (dimensions == 3)?s6_mu1:0;
