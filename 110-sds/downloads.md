 ...
 * Be aware that FeenoX is a backend. It **does not have a GUI**. Read the [documentation](https://seamplex.com/feenox/), especially the [description](https://www.seamplex.com/feenox/doc/feenox-desc.html) and the [FAQs](https://seamplex.com/feenox/doc/FAQ.html). Ask for help on the [GitHub discussions page](https://github.com/seamplex/feenox/discussions).
