...
p2 = newp; Point(p2) = {0+r,0,  0,  lc} ;
p3 = newp; Point(p3) = {0,  0+r,0,  lc} ;
p4 = newp; Point(p4) = {0,  0,  0+r,lc} ;
p5 = newp; Point(p5) = {0-r,0,  0,  lc} ;
p6 = newp; Point(p6) = {0,  0-r,0,  lc} ;
p7 = newp; Point(p7) = {0,  0,  0-r,lc} ;
